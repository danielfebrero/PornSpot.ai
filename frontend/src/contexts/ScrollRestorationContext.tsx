...
const ScrollRestorationContext = createContext<ScrollRestorationContextValue | undefined>(undefined);
...
export function ScrollRestorationProvider({ 
   ...
   */
  const saveScrollPosition = useCallback((key: string, position: ScrollPosition) => {
   ...
   */
  const getScrollPosition = useCallback((key: string): ScrollPosition | null => {
   ...
   */
  const hasStoredPosition = useCallback((key: string) => {
